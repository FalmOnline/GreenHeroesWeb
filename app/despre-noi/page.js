      ...
      <main className="flex flex-col justify-center mb-8">
        <article>
          ...
          <div className="flex flex-col gap-4 justify-center items-center container lg:max-w-screen-lg 2xl:max-w-screen-xl 3xl:max-w-screen-2xl mx-auto">
              ...
              <h5>În acord cu scopul și obiectivele noastre privind protecția mediului, ne dorim să asigurăm o educație și conștientizare adecvată a tinerilor în vederea dezvoltării unei abordări unitare și responsabile față de mediul înconjurător, Asociația Uman va participa la implementarea proiectului „Green Heroes”.</h5>
              <h6>„Proiect finanțat din Fondul pentru mediu, prin Administraţia Fondului pentru Mediu, în cadrul Programului vizând educaţia şi conştientizarea publicului privind protecţia mediului”, Nr. dosar proiect ECPM01202370100210 – 100 puncte<br /></h6>
